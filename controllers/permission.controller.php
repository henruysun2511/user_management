...
class PermissionController {
    ...
    public function create($body) {
        try {
            ...
            ResponseHelper::success("Tạo quyền mới thành công", ["id" => $id]);
        } catch (Exception $e) {
            ResponseHelper::error($e->getMessage(), 400);
        }
    }
    ...
    public function update($id, $body) {
        try {
            ...
            if ($success) {
                ResponseHelper::success("Cập nhật quyền thành công");
            } else {
...
// Xóa quyền
    public function delete($id) {
        try {
            ...
            if ($success) {
                ResponseHelper::success("Xóa quyền thành công");
            } else {
                ResponseHelper::error("Không tìm thấy quyền để xóa", 404);
            }
        } catch (Exception $e) {
            ResponseHelper::error($e->getMessage(), 400);
        }
